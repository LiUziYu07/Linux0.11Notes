...
+ 简单来说,boot的任务是利用ROM BIOS中断把head中的代码先读到一个位置,此时BIOS中断向量表位于0x000000,所以将head中的代码读到0x100000,之后将这段代码复制到0处,设置好保护模式之后,跳转到0处执行head代码![boot.s的作用](%E7%B4%A0%E6%9D%90/boot.s%E7%9A%84%E4%BD%9C%E7%94%A8.jpg)
